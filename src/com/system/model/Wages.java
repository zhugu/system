...
public class Wages {
    ...
    public Wages(Integer wagesid, String userid, Double basicwages, Double attendancereward, Double assessment, Double yearwages, Double publish, Double insurance, Double tax, Double wages, Double truewages, Date date) {
